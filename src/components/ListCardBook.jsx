...
function ListCardBook ({book, agregarAlCarrito}) {
    
    return (
        
            <Card className='h-100 position-relative shadow'>
                ...
                <ButtonAgregar onClick={()=>agregarAlCarrito(book)} title={'Agreagar libro al carrito'} alt={'Agreagar al carrito'} disabled={book.saleInfo.saleability === 'NOT_FOR_SALE'}  variant={book.saleInfo.saleability === 'NOT_FOR_SALE' ? 'outline-success rounded-circle' : 'success rounded-circle'}/>                             
                </span>
                        ...
                        <Col md={8} className='text-secondary'>
                            ...
                            <div className="ms-end my-3">
                                <small>       
                                    ...
                                    {book.saleInfo.isEbook ? (<Badge className="mt-0 mb-1 border border-primary text-primary bg-light me-1" pill>eBook</Badge>) : '' }
